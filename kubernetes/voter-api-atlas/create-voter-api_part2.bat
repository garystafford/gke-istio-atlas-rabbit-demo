...
istioctl kube-inject -f .\services\candidate-deployment.yaml
istioctl kube-inject -f .\services\election-deployment.yaml
istioctl kube-inject -f  .\services\voter-deployment.yaml
